...
const Login = () => {
  ...
  useEffect(() => {
    if (
      studentLoginError !== undefined &&
      studentLoginError !== null &&
      studentLoginError.toString() === "Invalid enrollment number or password"
    ) {
      toast.error("Invalid enrollment number or password");
      dispatch(clearMessages());
    }
    if (
      teacherLoginError !== undefined &&
      teacherLoginError !== null &&
      teacherLoginError.toString() === "Invalid employeeID or password"
    ) {
      toast.error("Invalid employeeID or password");
      dispatch(clearMessages());
    }
